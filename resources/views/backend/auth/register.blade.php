        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="mb-3" action="{{ route('register') }}" method="POST" enctype="multipart/form-data" id="my-form">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="penanggung_jawab" class="form-label">Penanaggungjawab</label>
                    <input
                      type="text"
                      class="form-control"
                      id="penanggung_jawab"
                      name="penanggung_jawab"
                      placeholder="Masukkan nama penanaggungjawab"
                      autofocus
                    />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="no_hp" class="form-label">No. Kontak</label>
                    <input
                      type="text"
                      class="form-control"
                      id="no_hp"
