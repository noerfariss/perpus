        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Pastikan Anda sudah terdaftar sebelumnya</p>

              <form class="mb-3" action="{{ route('forget') }}" method="POST" enctype="multipart/form-data" id="my-form">
                @csrf
                <div class="mb-3">
