            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-sm-3 mt-2"><input type="text" id="cari" class="form-control"
                            placeholder="Cari..." onkeyup="datatables.ajax.reload()"></div>
                    <div class="col-sm-9 mt-2">
                        @permission('user-create')
                        <a href="{{ route('user.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission
                        @permission('user-print')
                        <a href="{{ route('user.create') }}" class="btn btn-sm btn-outline-dark float-end me-2"><i
                                class='bx bxs-file-doc'></i> Export</a>
                        @endpermission
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalGantiPassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <form action="{{ route('ganti-password')}}" method="POST" enctype="multipart/form-data" id="form-ganti-password">
