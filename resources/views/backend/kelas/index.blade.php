                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9 mt-2">
                        @permission('kelas-create')
                            <a href="{{ route('kelas.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission

                        @permission('kelas-print')
                            {!! exportBtn('data', route('ajax-kelas'), 'KELAS') !!}
                        @endpermission
                    </div>
                </div>
