                        ...
                        <form action="{{ route('siswa.update', ['siswa' => $siswa->id]) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control kota-select" id="kota_id" name="kota_id"
                                        ...
                                        <option value="{{ $siswa->kota_id }}" selected>{{ $siswa->kota->kota }}</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="kelas_id" id="kelas_id" class="form-control kelas-select"
                                        ...
                                        <option value="{{ $siswa->kelas_id }}" selected>{{ $siswa->kelas->kelas }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="button-wrapper">
                                        ...
                                        <input type="hidden" name="foto" id="foto" value="{{ $siswa->foto }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div id="box-foto">
                                        @if ($siswa->foto)
                                            <img src="{{ url('/storage/anggota/thum_' . $siswa->foto) }}" class="rounded">
                                        @endif
                                    </div>
                                </div>
                            </div>
