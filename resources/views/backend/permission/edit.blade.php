          ...
          <div class="col-md-6">
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('permission.update', ['permission' => $permission->id])}}" method="POST" enctype="multipart/form-data" id="my-form">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                      <label class="col-sm-3 col-form-label" for="name">Permission</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="name" value="{{ $permission->grup }}">
                      </div>
                    </div>
                    <div class="row mb-3">
