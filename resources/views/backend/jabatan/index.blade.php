                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9 mt-2">
                        @permission('jabatan-create')
                            <a href="{{ route('jabatan.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission

                        @permission('jabatan-print')
                            {!! exportBtn('data', route('ajax-jabatan'), 'JABATAN') !!}
                        @endpermission
                    </div>
                </div>
