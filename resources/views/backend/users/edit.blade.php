          ...
          <div class="col-md-6">
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('user.update', ['user' => $user->id])}}" method="POST" enctype="multipart/form-data" id="my-form">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="role[]" id="role" class="form-control role-select" data-url="{{ route('drop-role') }}">
