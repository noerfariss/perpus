                        ...
                        <form action="{{ route('guru.update', ['guru' => $guru->id]) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control kota-select" id="kota_id" name="kota_id"
                                        ...
                                        <option value="{{ $guru->kota_id }}" selected>{{ $guru->kota->kota }}</option>
                                    </select>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select name="kelas_id" id="kelas_id" class="form-control kelas-select"
                                        data-ajax--url="{{ route('drop-kelas') }}">
                                        @if ($guru->kelas_id)
                                        <option value="{{ $guru->kelas_id }}" selected>{{ $guru->kelas->kelas }}
                                        </option>
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="button-wrapper">
                                        ...
                                        <input type="hidden" name="foto" id="foto" value="{{ $guru->foto }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div id="box-foto">
                                        @if ($guru->foto)
                                            <img src="{{ url('/storage/anggota/thum_' . $guru->foto) }}" class="rounded">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-sm-9">
                                    <a href="{{ route('guru.index') }}" class="btn btn-link btn-sm">Kembali</a>
