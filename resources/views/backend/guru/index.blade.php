...
@section('konten')
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-7 mt-2">
                        @permission('guru-create')
                            <a href="{{ route('guru.create') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                        @endpermission

                        @permission('guru-print')
                            {!! exportBtn(['data', 'foto'], route('ajax-guru'), 'DATA GURU') !!}
                        @endpermission
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalDetailAnggota" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetailAnggotaLabel">Guru</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <span id="notif"></span>
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-4 col-form-label" for="kelas">wali Kelas</label>
                        <div class="col-sm-8">
